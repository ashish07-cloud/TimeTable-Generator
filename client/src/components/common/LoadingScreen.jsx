  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-white dark:bg-black transition-colors duration-500">
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute w-20 h-20 border-4 border-t-orange-500 border-r-transparent border-b-transparent border-l-transparent rounded-full animate-spin"></div>
        
        {/* Pulsing Core Icon with Orange Gradient */}
        <div className="absolute flex items-center justify-center bg-gradient-to-br from-orange-500 to-orange-700 w-12 h-12 rounded-2xl shadow-lg shadow-orange-500/40 animate-pulse">
      ...
      <div className="mt-8 text-center">
        <h2 className="text-xl font-bold tracking-tighter text-gray-900 dark:text-white">
          SmartTable <span className="text-orange-500">AI</span>
        </h2>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-orange-500/10 dark:bg-orange-500/5 blur-[100px] rounded-full pointer-events-none"></div>
    </div>
  );
};
